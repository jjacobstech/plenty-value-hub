...
export default function AdminDashboard() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold bg-[hsl(var(--foreground))]" style={{ color: '#E8EDF5' }}>Admin Dashboard</h1>
        <p style={{ color: '#5A7399' }}>Marketplace overview and key metrics</p>
      </div>
