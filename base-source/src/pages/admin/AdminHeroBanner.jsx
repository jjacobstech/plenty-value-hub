...
const DEFAULT_HERO = 'https://media.base44.com/images/public/6a28952a913beeab7a9b7a70/3e3ab06cc_ab6877fd-0ad3-41a2-a9aa-11080b42b55e.png';
...
export default function AdminHeroBanner() {
  ...
  const saveMutation = useMutation({
    mutationFn: async (imageUrl) => {
      if (heroSetting) {
        ...
        return base44.entities.SiteSettings.create({ key: HERO_KEY, label: 'Hero Banner Image', value: imageUrl });
      }
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['site-settings'] });
      setPreviewUrl(null);
      toast({ title: 'Hero banner updated!', description: 'The homepage hero image has been updated.' });
    },
  });
  ...
  return (
    <div className="p-6 space-y-6 max-w-4xl mx-auto">
      <div>
        <h1 className="text-2xl font-bold" style={{ color: '#001845' }}>Hero Banner Management</h1>
        <p className="text-muted-foreground mt-1">Upload and manage the homepage hero banner image.</p>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          {isLoading ? (
            ...
            <div className="relative w-full rounded-lg overflow-hidden border" style={{ aspectRatio: '820/312' }}>
              <img
                src={activeImage}
        ...
        <CardContent className="space-y-4">
          ...
          {previewUrl && (
            <div className="space-y-3">
              <p className="text-sm font-semibold" style={{ color: '#001845' }}>Preview</p>
              <div className="relative w-full rounded-lg overflow-hidden border-2 border-[#81C14B]" style={{ aspectRatio: '820/312' }}>
                <img src={previewUrl} alt="Preview" className="w-full h-full object-cover" />
                <div className="absolute top-2 right-2">
                  <Badge className="border-0 text-white text-xs" style={{ backgroundColor: '#001845' }}>
