...
import { UserCircle, Globe, Instagram, Twitter, Youtube, Phone, MapPin, CheckCircle2, Edit2, Save, Zap } from 'lucide-react';
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2">
              ...
              <Input disabled={!editing} value={form.marketing_channels} onChange={(e) => setForm({ ...form, marketing_channels: e.target.value })} placeholder="e.g. WhatsApp, Instagram, Email, Blog, YouTube" />
            </div>
          </div>
        </CardContent>
      </Card>
