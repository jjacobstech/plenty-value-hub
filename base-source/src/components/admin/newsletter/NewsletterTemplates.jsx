    ...
    >
      ...
      <div className="flex items-center justify-between px-5 py-4" style={{ borderBottom: '1px solid #e5e7eb' }}>
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold" style={{ color: '#001845' }}>Newsletter Templates</h3>
        </div>
        <button
          onClick={onClose}
      ...
      <div className="p-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-3">
        {TEMPLATES.map((tpl) => (
          <button
            ...
            onMouseEnter={(e) => { e.currentTarget.style.borderColor = '#81C14B'; e.currentTarget.style.background = 'rgba(129,193,75,0.06)'; }}
          ...
          >
            ...
            <p className="text-sm font-semibold mb-1" style={{ color: '#001845' }}>{tpl.label}</p>
            <p className="text-xs leading-relaxed line-clamp-2" style={{ color: '#6b7280' }}>{tpl.subject}</p>
          </button>
        ))}
      </div>
    </div>
