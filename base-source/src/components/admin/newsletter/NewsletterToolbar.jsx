...
export default function NewsletterToolbar({ onImageInsert, onVideoInsert }) {
  ...
  return (
    <>
      ...
      >
        {/* Font Family */}
        <select className="ql-font rounded-lg px-2 py-1 text-xs" style={{ background: '#fff', color: '#001845', border: '1px solid #e5e7eb', outline: 'none' }}>
        ...
        {/* Font Size */}
        <select className="ql-size rounded-lg px-2 py-1 text-xs" style={{ background: '#fff', color: '#001845', border: '1px solid #e5e7eb', outline: 'none' }}>
        ...
        {/* Headings */}
        <select className="ql-header rounded-lg px-2 py-1 text-xs" style={{ background: '#fff', color: '#001845', border: '1px solid #e5e7eb', outline: 'none' }}>
          <option value="">Normal</option>
        ...
        {/* Alignment */}
        <select className="ql-align rounded-lg px-2 py-1 text-xs" style={{ background: '#0A1628', color: '#E8EDF5', border: '1px solid #1A2E50', outline: 'none' }}>
          <option value="" />
          <option value="center" />
          <option value="right" />
        ...
        <input ref={imageInputRef} type="file" accept="image/*" className="hidden" onChange={onImageInsert} />
        <input ref={videoInputRef} type="file" accept="video/*" className="hidden" onChange={onVideoInsert} />
      </div>
