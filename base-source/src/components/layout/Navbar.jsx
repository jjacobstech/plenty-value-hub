            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="center" className="w-60 p-2">
                <DropdownMenuItem asChild>
                  <Link to="/for-partners#vendor" className="flex items-start gap-3 p-2 rounded-lg">
                ...
                <DropdownMenuItem asChild>
                  <Link to="/for-partners#affiliate" className="flex items-start gap-3 p-2 rounded-lg">
            ...
            <SheetContent side="right" className="w-72">
              <div className="flex flex-col gap-1 mt-8">
                ...
                <div className="border-t pt-3 mt-2">
                  ...
                  <Link to="/for-partners" onClick={() => setOpen(false)}>
