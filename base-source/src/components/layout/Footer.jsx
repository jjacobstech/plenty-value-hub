        ...
        <div className="absolute inset-0 flex items-center px-8 md:px-16">
          <div className="max-w-lg">
            ...
            <div className="flex gap-3 mt-5">
              <Link to="/register" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg text-sm font-semibold text-white transition-opacity hover:opacity-90" style={{ backgroundColor: '#81C14B' }}>
                Get Started
              </Link>
              <Link to="/marketplace" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg text-sm font-semibold border transition-colors hover:bg-white/10" style={{ borderColor: 'rgba(255,255,255,0.35)', color: 'rgba(255,255,255,0.85)' }}>
                Explore Marketplace
              </Link>
            </div>
          </div>
        ...
        <div className="border-t border-white/10 pt-10 pb-6">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex gap-2">
              ...
              />
              <Button onClick={handleSubscribe} className="h-11 px-5 font-semibold shrink-0" style={{ backgroundColor: '#81C14B', color: '#fff' }}>
                Subscribe
              </Button>
            </div>
          </div>
