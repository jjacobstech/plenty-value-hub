...
const routes = {
  ...
  'products.index': {
    ...
    tokens: [{"old":"/api/admin/products","type":0,"val":"api","end":""},{"old":"/api/admin/products","type":0,"val":"admin","end":""},{"old":"/api/admin/products","type":0,"val":"products","end":""}],
    types: placeholder as Registry['products.index']['types'],
  },
  'products.show': {
    methods: ["GET","HEAD"],
    pattern: '/api/admin/products/:id',
    tokens: [{"old":"/api/admin/products/:id","type":0,"val":"api","end":""},{"old":"/api/admin/products/:id","type":0,"val":"admin","end":""},{"old":"/api/admin/products/:id","type":0,"val":"products","end":""},{"old":"/api/admin/products/:id","type":1,"val":"id","end":""}],
    types: placeholder as Registry['products.show']['types'],
  },
  'newsletters.subscribe': {
    methods: ["POST"],
    pattern: '/api/admin/newsletters/subscribe',
    tokens: [{"old":"/api/admin/newsletters/subscribe","type":0,"val":"api","end":""},{"old":"/api/admin/newsletters/subscribe","type":0,"val":"admin","end":""},{"old":"/api/admin/newsletters/subscribe","type":0,"val":"newsletters","end":""},{"old":"/api/admin/newsletters/subscribe","type":0,"val":"subscribe","end":""}],
    types: placeholder as Registry['newsletters.subscribe']['types'],
  },
  'newsletters.unsubscribe': {
    methods: ["POST"],
    pattern: '/api/admin/newsletters/unsubscribe',
    tokens: [{"old":"/api/admin/newsletters/unsubscribe","type":0,"val":"api","end":""},{"old":"/api/admin/newsletters/unsubscribe","type":0,"val":"admin","end":""},{"old":"/api/admin/newsletters/unsubscribe","type":0,"val":"newsletters","end":""},{"old":"/api/admin/newsletters/unsubscribe","type":0,"val":"unsubscribe","end":""}],
  ...
  'affiliate_links.track_click': {
    ...
    tokens: [{"old":"/api/admin/affiliate-links/track-click","type":0,"val":"api","end":""},{"old":"/api/admin/affiliate-links/track-click","type":0,"val":"admin","end":""},{"old":"/api/admin/affiliate-links/track-click","type":0,"val":"affiliate-links","end":""},{"old":"/api/admin/affiliate-links/track-click","type":0,"val":"track-click","end":""}],
    types: placeholder as Registry['affiliate_links.track_click']['types'],
  },
  'reviews.index': {
    methods: ["GET","HEAD"],
    pattern: '/api/admin/reviews',
    tokens: [{"old":"/api/admin/reviews","type":0,"val":"api","end":""},{"old":"/api/admin/reviews","type":0,"val":"admin","end":""},{"old":"/api/admin/reviews","type":0,"val":"reviews","end":""}],
  ...
  'orders.index': {
    ...
    tokens: [{"old":"/api/admin/orders","type":0,"val":"api","end":""},{"old":"/api/admin/orders","type":0,"val":"admin","end":""},{"old":"/api/admin/orders","type":0,"val":"orders","end":""}],
    types: placeholder as Registry['orders.index']['types'],
  },
  'orders.show': {
    methods: ["GET","HEAD"],
    pattern: '/api/admin/orders/:id',
    tokens: [{"old":"/api/admin/orders/:id","type":0,"val":"api","end":""},{"old":"/api/admin/orders/:id","type":0,"val":"admin","end":""},{"old":"/api/admin/orders/:id","type":0,"val":"orders","end":""},{"old":"/api/admin/orders/:id","type":1,"val":"id","end":""}],
  ...
  'affiliate_links.index': {
    ...
    tokens: [{"old":"/api/admin/affiliate-links","type":0,"val":"api","end":""},{"old":"/api/admin/affiliate-links","type":0,"val":"admin","end":""},{"old":"/api/admin/affiliate-links","type":0,"val":"affiliate-links","end":""}],
  ...
  'affiliate_links.update': {
    ...
    tokens: [{"old":"/api/admin/affiliate-links/:id","type":0,"val":"api","end":""},{"old":"/api/admin/affiliate-links/:id","type":0,"val":"admin","end":""},{"old":"/api/admin/affiliate-links/:id","type":0,"val":"affiliate-links","end":""},{"old":"/api/admin/affiliate-links/:id","type":1,"val":"id","end":""}],
  ...
  'profile.update_affiliate': {
    ...
    tokens: [{"old":"/api/admin/profile/affiliate","type":0,"val":"api","end":""},{"old":"/api/admin/profile/affiliate","type":0,"val":"admin","end":""},{"old":"/api/admin/profile/affiliate","type":0,"val":"profile","end":""},{"old":"/api/admin/profile/affiliate","type":0,"val":"affiliate","end":""}],
    types: placeholder as Registry['profile.update_affiliate']['types'],
  },
  'profile.update_vendor': {
    methods: ["PUT"],
    pattern: '/api/admin/profile/vendor',
    tokens: [{"old":"/api/admin/profile/vendor","type":0,"val":"api","end":""},{"old":"/api/admin/profile/vendor","type":0,"val":"admin","end":""},{"old":"/api/admin/profile/vendor","type":0,"val":"profile","end":""},{"old":"/api/admin/profile/vendor","type":0,"val":"vendor","end":""}],
    types: placeholder as Registry['profile.update_vendor']['types'],
  },
  'profile.upload_image': {
    methods: ["POST"],
    pattern: '/api/admin/profile/upload-image',
    tokens: [{"old":"/api/admin/profile/upload-image","type":0,"val":"api","end":""},{"old":"/api/admin/profile/upload-image","type":0,"val":"admin","end":""},{"old":"/api/admin/profile/upload-image","type":0,"val":"profile","end":""},{"old":"/api/admin/profile/upload-image","type":0,"val":"upload-image","end":""}],
  ...
  'products.approve': {
    ...
    tokens: [{"old":"/api/admin/products/:id/approve","type":0,"val":"api","end":""},{"old":"/api/admin/products/:id/approve","type":0,"val":"admin","end":""},{"old":"/api/admin/products/:id/approve","type":0,"val":"products","end":""},{"old":"/api/admin/products/:id/approve","type":1,"val":"id","end":""},{"old":"/api/admin/products/:id/approve","type":0,"val":"approve","end":""}],
  ...
  'reviews.approve': {
    ...
    tokens: [{"old":"/api/admin/reviews/:id/approve","type":0,"val":"api","end":""},{"old":"/api/admin/reviews/:id/approve","type":0,"val":"admin","end":""},{"old":"/api/admin/reviews/:id/approve","type":0,"val":"reviews","end":""},{"old":"/api/admin/reviews/:id/approve","type":1,"val":"id","end":""},{"old":"/api/admin/reviews/:id/approve","type":0,"val":"approve","end":""}],
    types: placeholder as Registry['reviews.approve']['types'],
  },
  'blog_posts.index': {
    methods: ["GET","HEAD"],
    pattern: '/api/admin/blog-posts',
    tokens: [{"old":"/api/admin/blog-posts","type":0,"val":"api","end":""},{"old":"/api/admin/blog-posts","type":0,"val":"admin","end":""},{"old":"/api/admin/blog-posts","type":0,"val":"blog-posts","end":""}],
  ...
  'blog_posts.update': {
    ...
    tokens: [{"old":"/api/admin/blog-posts/:id","type":0,"val":"api","end":""},{"old":"/api/admin/blog-posts/:id","type":0,"val":"admin","end":""},{"old":"/api/admin/blog-posts/:id","type":0,"val":"blog-posts","end":""},{"old":"/api/admin/blog-posts/:id","type":1,"val":"id","end":""}],
  ...
  'newsletter_admin.update': {
    ...
    tokens: [{"old":"/api/admin/newsletters/:id","type":0,"val":"api","end":""},{"old":"/api/admin/newsletters/:id","type":0,"val":"admin","end":""},{"old":"/api/admin/newsletters/:id","type":0,"val":"newsletters","end":""},{"old":"/api/admin/newsletters/:id","type":1,"val":"id","end":""}],
  ...
  'email_campaigns.index': {
    ...
    tokens: [{"old":"/api/admin/email-campaigns","type":0,"val":"api","end":""},{"old":"/api/admin/email-campaigns","type":0,"val":"admin","end":""},{"old":"/api/admin/email-campaigns","type":0,"val":"email-campaigns","end":""}],
  ...
  'email_campaigns.update': {
    ...
    tokens: [{"old":"/api/admin/email-campaigns/:id","type":0,"val":"api","end":""},{"old":"/api/admin/email-campaigns/:id","type":0,"val":"admin","end":""},{"old":"/api/admin/email-campaigns/:id","type":0,"val":"email-campaigns","end":""},{"old":"/api/admin/email-campaigns/:id","type":1,"val":"id","end":""}],
  ...
  'site_settings.index': {
    ...
    tokens: [{"old":"/api/admin/site-settings","type":0,"val":"api","end":""},{"old":"/api/admin/site-settings","type":0,"val":"admin","end":""},{"old":"/api/admin/site-settings","type":0,"val":"site-settings","end":""}],
    types: placeholder as Registry['site_settings.index']['types'],
  },
  'site_settings.show': {
    methods: ["GET","HEAD"],
    pattern: '/api/admin/site-settings/:key',
    tokens: [{"old":"/api/admin/site-settings/:key","type":0,"val":"api","end":""},{"old":"/api/admin/site-settings/:key","type":0,"val":"admin","end":""},{"old":"/api/admin/site-settings/:key","type":0,"val":"site-settings","end":""},{"old":"/api/admin/site-settings/:key","type":1,"val":"key","end":""}],
  ...
  'site_settings.upload_image': {
    ...
    tokens: [{"old":"/api/admin/site-settings/upload-image","type":0,"val":"api","end":""},{"old":"/api/admin/site-settings/upload-image","type":0,"val":"admin","end":""},{"old":"/api/admin/site-settings/upload-image","type":0,"val":"site-settings","end":""},{"old":"/api/admin/site-settings/upload-image","type":0,"val":"upload-image","end":""}],
