      ...
      return (
            <div className={`space-y-2 sm:space-y-3 md:space-y-4 w-full ${className}`}>
                  ...
                  <div
                        ...
                        onDrop={handleDrop}
                        className={`relative border-2 border-dashed rounded-lg p-3 sm:p-4 md:p-6 transition-all cursor-pointer w-full ${dragActive ? 'border-blue-500 bg-blue-50' : 'border-gray-300 bg-gray-50 hover:border-gray-400'
                  ...
                  {helpText && <p className="text-xs sm:text-xs md:text-sm text-gray-600 break-words">{helpText}</p>}
                  ...
                  {error && (
                        <div className="flex items-start gap-2 sm:gap-3 p-2 sm:p-3 md:p-4 bg-red-50 border border-red-200 rounded-lg w-full">
                              ...
                              <div className="flex-1 min-w-0">
                                    <p className="text-xs sm:text-sm md:text-base font-medium text-red-900 break-words">Upload Failed</p>
                                    <p className="text-xs sm:text-xs md:text-sm text-red-700 mt-0.5 sm:mt-1 break-words">{error}</p>
                              </div>
                              <button
                                    type="button"
