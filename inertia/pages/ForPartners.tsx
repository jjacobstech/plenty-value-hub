...
const VENDOR_BENEFITS = [
  {
    icon: Globe,
    title: 'Global Reach',
    desc: 'Access 11,000+ engaged subscribers and a growing affiliate network promoting your products.',
  },
  {
    icon: BarChart3,
    title: 'Powerful Dashboard',
    desc: 'Track orders, revenue, product performance and manage your store from one place.',
  },
  {
    icon: TrendingUp,
    title: 'Affiliate-Driven Sales',
    desc: 'Let affiliates promote your products and only pay commission on actual sales made.',
  },
  {
    icon: Shield,
    title: 'Trusted Platform',
    desc: 'Verified KYC process ensures marketplace quality and buyer confidence.',
  },
]
...
const VENDOR_STEPS = [
  ...
  },
  {
    num: '02',
    title: 'Complete KYC',
    desc: 'Verify your business with our simple onboarding process.',
  },
  {
    num: '03',
    title: 'List Products',
  ...
  },
  {
    ...
    desc: 'Affiliates promote your products and orders come in.',
  },
...
const AFFILIATE_BENEFITS = [
  {
    ...
    desc: 'Earn industry-leading commissions on every sale you generate.',
  },
  {
    icon: Link2,
    title: 'Unique Tracking Links',
    desc: 'Generate trackable affiliate links for any product in the marketplace.',
  },
  {
    icon: BarChart3,
    title: 'Real-time Analytics',
    desc: 'Monitor clicks, conversions, and earnings with detailed reporting.',
  },
  {
    icon: Package,
    title: 'Curated Products',
    desc: 'Choose from hundreds of quality-vetted products across all categories.',
  },
]
...
const AFFILIATE_STEPS = [
  ...
  },
  {
    ...
    desc: 'Explore our curated marketplace and find products to promote.',
  },
  {
    num: '03',
  ...
  },
  {
    ...
    desc: 'Get paid for every sale driven through your links.',
  },
]
  ...
  return (
    <Card className="border-border/50 hover:shadow-md transition-all duration-200">
      <CardContent className="p-6">
        ...
        <h4 className="font-semibold text-base mb-2" style={{ color: '#001845' }}>
          {title}
        </h4>
...
function StepItem({ num, title, desc, color }) {
  return (
    <div className="flex gap-4">
      ...
      <div>
        <h4 className="font-semibold mb-1" style={{ color: '#001845' }}>
          {title}
        </h4>
      ...
      <section className="py-20 md:py-28" style={{ backgroundColor: '#001845' }}>
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <Badge
            ...
            style={{ backgroundColor: 'rgba(129,193,75,0.2)', color: '#81C14B' }}
          >
          ...
          <p className="text-slate-300 text-lg max-w-2xl mx-auto mb-8">
            Whether you're a vendor with products to sell or an affiliate looking to earn
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link href="/register">
              <Button
                size="lg"
                variant="outline"
                className="text-base px-8 border-white/40 text-white hover:bg-white/10 hover:text-white"
              >
                Become an Affiliate
              </Button>
            </Link>
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <Badge className="border-0" style={{ backgroundColor: '#001845', color: '#fff' }}>
              For Vendors
            </Badge>
          </div>
          <h2
          ...
          <p className="text-muted-foreground max-w-2xl mb-12 text-lg">
            List your products on Plenty Value and instantly tap into our network of motivated
            affiliates and 11,000+ engaged subscribers.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="font-display text-2xl font-bold mb-8" style={{ color: '#001845' }}>
                How Vendors Earn
              </h3>
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <Badge className="border-0" style={{ backgroundColor: '#81C14B', color: '#fff' }}>
              For Affiliates
            </Badge>
          </div>
          <h2
          ...
          <p className="text-muted-foreground max-w-2xl mb-12 text-lg">
            Join our affiliate network and earn up to 50% commission promoting products you believe
            in — no inventory needed.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div
              className="bg-gradient-to-br rounded-2xl p-8 text-white order-2 md:order-1"
              style={{ background: 'linear-gradient(135deg, #81C14B, #5a9a2e)' }}
            >
...
ForPartners.layout = (page: React.ReactNode) => <PublicLayout>{page}</PublicLayout>
