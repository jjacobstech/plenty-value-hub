...
function Field({ id, label, required = false, children, errors }) {
  return (
  ...
  return (
    <div className="w-full max-w-xl mx-auto">
      <div className="text-center mb-8">
        ...
        <h2 className="text-2xl font-bold" style={{ color: '#001845' }}>
          Vendor Verification
        </h2>
        <p className="text-muted-foreground text-sm mt-1">
          Help us verify your business to maintain marketplace quality
        </p>
      </div>
      ...
      <div className="flex items-center gap-3 bg-green-50 border border-green-200 rounded-xl p-3 mb-6">
        ...
        <p className="text-sm text-green-800">
          KYC verification builds buyer trust and improves your sales performance.
        </p>
      </div>
      ...
      >
        ...
        <div>
          ...
          <div className="space-y-4">
            <Field id="businessName" label="Business Name" required errors={errors}>
              <Input
                id="businessName"
            ...
            <Field id="businessType" label="Type of Business" required errors={errors}>
            ...
            <Field id="description" label="Business Description" required errors={errors}>
              <Textarea
                id="description"
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <Field id="state" label="State / Region" required errors={errors}>
              <Input
                id="state"
        ...
        <div>
          ...
          <div className="space-y-4">
            <Field id="socialMedia" label="Social Media Account / Page" required errors={errors}>
            ...
            <Field id="website" label="Website URL (Optional)" errors={errors}>
              <div className="relative">
        ...
        <div>
          ...
          <div className="space-y-4">
            <Field id="contactPhone" label="Phone Number" required errors={errors}>
              <Input
                id="contactPhone"
                type="tel"
...
VendorKYC.layout = (page: React.ReactNode) => (
  <DashboardLayout role="vendor">{page}</DashboardLayout>
)
