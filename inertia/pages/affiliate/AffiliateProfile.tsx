...
import { UserCircle, Globe, Mail, AtSign, Video, Phone, MapPin, CheckCircle2, Edit2, Save, Zap, Upload, Loader2, ImagePlus } from 'lucide-react';
  ...
  return (
    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <Card className="overflow-hidden">
          <div className="h-36 relative" style={{ background: 'linear-gradient(135deg, #715AFF 0%, #001845 100%)' }}>
            ...
            <div className="-mt-8 mb-4 flex items-end gap-4">
              <div className="relative w-20 h-20">
                ...
                <input
                  ...
                  className="hidden"
                  onChange={e => { const f = e.target.files?.[0]; if (f) handleImageUpload(f, 'profile_picture') }}
                />
            </div>
              <div className="">
                ...
                <Badge className="bg-[#715AFF] text-white border-0 text-xs">
                  ...
                  {form.niche && <Badge variant="outline" className="text-xs">{form.niche}</Badge>}
              </div>
            </div>
          </div>
        ...
        <CardContent className="space-y-4">
            ...
            <div className="col-span-2">
              <Label>Marketing Channels</Label>
                <Input disabled={!editing} value={form.marketingChannels} onChange={e => setForm({ ...form, marketingChannels: e.target.value })} placeholder="e.g. WhatsApp, Email, Blog, YouTube" />
            </div>
          </div>
        </CardContent>
      </Card>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="ml-auto text-right">
              <p className="text-2xl font-bold text-[#715AFF]">
                  {[form.bio, form.instagram, form.marketingChannels, form.niche, form.profilePicture].filter(Boolean).length * 20}%
              </p>
