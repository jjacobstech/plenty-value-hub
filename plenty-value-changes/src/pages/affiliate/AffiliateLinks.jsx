        ...
        <CardContent className="p-0">
          {links.length > 0 ? (
              ...
              <TableBody>
                {links.map((link) => (
                  <TableRow key={link.id}>
                    ...
                    <TableCell>
                      <span
                        className={`text-xs px-2 py-0.5 rounded-full font-medium ${link.status === 'active' ? 'bg-green-100 text-green-700' : 'bg-slate-100 text-slate-500'}`}
                      >
                        {link.status}
                      </span>
                    </TableCell>
            ...
            <div className="text-center py-16">
              ...
              <Link to="/affiliate/products">
                <Button style={{ backgroundColor: '#81C14B' }} className="text-white">
