  ...
  return (
    <div className="space-y-6 max-w-3xl">
      ...
      <Card className="overflow-hidden">
        <div
          className="h-28 relative text-[hsl(var(--card))] bg-[hsl(var(--success))]"
        ...
        <CardContent className="pt-0 pb-5 px-6 relative">
          <div className="-mt-10 mb-4 flex items-end gap-4">
            ...
            <div className="mb-2">
              <h2 className="font-bold text-lg text-[hsl(var(--foreground))]">
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2">
              ...
              <Input
                disabled={!editing}
                value={form.marketing_channels}
                onChange={(e) => setForm({ ...form, marketing_channels: e.target.value })}
                placeholder="e.g. WhatsApp, Instagram, Email, Blog, YouTube"
              />
            </div>
          </div>
        </CardContent>
