...
export default function AffiliateDashboard() {
  ...
  const { data: links = [] } = useQuery({
    ...
    queryFn: () =>
      base44.entities.AffiliateLink.filter({ affiliate_id: user.id }, '-created_date', 100),
    enabled: !!user,
  })
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <div
              ...
              style={{ background: 'rgba(129,193,75,0.1)' }}
            >
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4" style={{ color: '#81C14B' }} />
                <span className="text-sm font-medium" style={{ color: '#81C14B' }}>
                  Confirmed
                </span>
              </div>
              <span className="font-bold" style={{ color: '#81C14B' }}>
            ...
            {links.length > 0 ? (
                ...
                <TableBody>
                  {links.slice(0, 6).map((link) => (
                    <TableRow key={link.id}>
                      ...
                      <TableCell className="font-semibold text-xs" style={{ color: '#81C14B' }}>
              ...
              <div className="text-center py-10">
                <p className="text-muted-foreground text-sm mb-3">
                  No links yet. Start promoting products!
                </p>
                <Link to="/affiliate/products">
