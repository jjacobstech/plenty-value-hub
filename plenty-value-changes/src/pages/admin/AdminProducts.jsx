                ...
                <TableRow key={p.id}>
                  ...
                  <TableCell>
                    <Button
                      ...
                      size="icon"
                      onClick={() =>
                        updateMutation.mutate({ id: p.id, data: { is_featured: !p.is_featured } })
                      }
                    >
                      <Star
                        className={`w-4 h-4 ${p.is_featured ? 'fill-primary text-primary' : 'text-muted-foreground'}`}
                      />
                    </Button>
                  </TableCell>
                  <TableCell>
                    <div className="flex gap-1">
                      <Button
                        ...
                        style={{ color: '#81C14B' }}
                        onClick={() =>
                          updateMutation.mutate({ id: p.id, data: { status: 'approved' } })
                        }
                      >
                      ...
                      <Button
                        ...
                        onClick={() =>
                          updateMutation.mutate({ id: p.id, data: { status: 'rejected' } })
                        }
                      >
