...
export default function AdminNewsletterList() {
  ...
  const deleteNL = useMutation({
    ...
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ['newsletters-list'] })
        ...
        <CardContent>
          {filtered.length === 0 ? (
            <div className="text-center py-12 text-muted-foreground">
              ...
              <p>
                No newsletters yet.{' '}
                <Link to="/admin/newsletter" className="text-primary">
                  Compose one!
                </Link>
              </p>
            </div>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-4 text-xs text-gray-400">
                      <span className="flex items-center gap-1">
                        ...
                        {n.open_count || 0} opens
                      </span>
                      <span className="flex items-center gap-1">
                        <MousePointer className="w-3 h-3" />
                        {n.click_count || 0} clicks
                      </span>
