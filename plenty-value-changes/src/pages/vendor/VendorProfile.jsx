      ...
      <Card className="overflow-hidden">
          ...
          <div className="absolute bottom-4 left-6 flex items-end gap-4">
            ...
            <div className="mb-1">
              <h2 className="text-white font-bold text-lg drop-shadow">
                {form.business_name || user.full_name || 'Your Business'}
              </h2>
        ...
        <CardContent className="pt-4 pb-5 px-6">
          <p className="text-sm text-muted-foreground">
            {form.business_description || 'No description yet.'}
          </p>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <Input
              ...
              onChange={(e) => setForm({ ...form, business_logo: e.target.value })}
              placeholder="https://..."
            />
          </div>
          <div>
            ...
            <Input
              disabled={!editing}
              value={form.cover_banner}
              onChange={(e) => setForm({ ...form, cover_banner: e.target.value })}
              placeholder="https://..."
            />
          </div>
        </CardContent>
