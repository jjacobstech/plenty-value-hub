...
export default function Home() {
  ...
  const { data: featuredProducts = [] } = useQuery({
    ...
    queryFn: () =>
      base44.entities.Product.filter({ status: 'approved', is_featured: true }, '-created_date', 8),
  })
  ...
  return (
    <div>
      ...
      <section
        ...
        style={{ backgroundColor: '#001845', minHeight: 'clamp(280px, 45vw, 520px)' }}
      >
            ...
            >
              {STATS.map((stat, i) => (
                <div key={i} className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="font-bold text-sm leading-none text-[hsl(var(--background))]">
                      {stat.value}
                    </p>
