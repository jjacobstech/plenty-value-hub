...
const FOOTER_IMAGE =
  'https://media.base44.com/images/public/6a235579fdf4cce1a3f803a3/e59786943_generated_image.png'
...
export default function Footer() {
  ...
  const handleSubscribe = async () => {
    if (!email) return
    await base44.entities.NewsletterSubscriber.create({ email, source: 'footer' })
    ...
    <footer style={{ backgroundColor: '#001845' }} className="text-white">
      ...
      <div className="relative w-full overflow-hidden" style={{ height: '260px' }}>
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(to right, rgba(0,24,69,0.9) 0%, rgba(0,24,69,0.55) 55%, transparent 100%)',
          }}
        />
        <div
          className="absolute inset-0"
          style={{ background: 'linear-gradient(to top, #001845 0%, transparent 40%)' }}
        />
        <div className="absolute inset-0 flex items-center px-8 md:px-16">
          <div className="max-w-lg">
            ...
            <div className="flex gap-3 mt-5">
              ...
              <Link
                to="/marketplace"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg text-sm font-semibold border transition-colors hover:bg-white/10"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-10 mb-12">
          ...
          <div className="sm:col-span-2">
            ...
            <p className="text-sm leading-relaxed mb-5" style={{ color: 'rgba(255,255,255,0.55)' }}>
              Africa's leading affiliate marketplace and product review platform — connecting
              consumers, vendors, and affiliates.
            </p>
            <div className="flex items-center gap-3">
              <a
                href="https://www.instagram.com/_plentyvalue_?igsh=M3A1ZHBidHNyemgw"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-lg flex items-center justify-center transition-all hover:bg-[#81C14B] group"
                style={{ border: '1px solid rgba(255,255,255,0.2)' }}
              >
                <Instagram className="w-4 h-4" style={{ color: 'rgba(255,255,255,0.7)' }} />
              </a>
              <a
                href="https://www.facebook.com/share/1GrEVUiJ4G/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-lg flex items-center justify-center transition-all hover:bg-[#81C14B]"
                style={{ border: '1px solid rgba(255,255,255,0.2)' }}
              >
                <Facebook className="w-4 h-4" style={{ color: 'rgba(255,255,255,0.7)' }} />
              </a>
              <a
