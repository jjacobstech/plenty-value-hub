...
export default function ProductCard({ product, showCommission = false }) {
  return (
    <Link to={`/product/${product.id}`}>
      <Card
        className="group overflow-hidden border-border/50 hover:shadow-lg transition-all duration-300 h-full"
        style={{ '--tw-border-opacity': 1 }}
        onMouseEnter={(e) => (e.currentTarget.style.borderColor = 'rgba(129,193,75,0.4)')}
