...
export default function BrandLogo({
  ...
  const logoUrl =
    'https://media.base44.com/images/public/6a235579fdf4cce1a3f803a3/f40bff49e_Logo.svg'
  const wordmarkUrl =
    'https://media.base44.com/images/public/6a235579fdf4cce1a3f803a3/b91f1957b_wordmark.svg'
      ...
      {(variant === 'wordmark' || variant === 'combined') &&
        (darkBg ? (
          ...
          <img
            src={wordmarkUrl}
            alt="Plenty Value"
            style={{ height: Math.round(size * 0.65) }}
            className="object-contain flex-shrink-0"
          />
        ))}
    </span>
