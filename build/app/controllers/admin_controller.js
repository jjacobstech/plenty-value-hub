...
export default class AdminController {
    async getPlatformStats({ auth, response }) {
        ...
        const platformRevenue = completedOrders.reduce((sum, o) => sum + new Decimal(o.platformFee || 0).toNumber(), 0);
        const totalCommissions = completedOrders.reduce((sum, o) => sum + new Decimal(o.commissionAmount || 0).toNumber(), 0);
