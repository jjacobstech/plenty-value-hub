...
export const createProductValidator = vine.create({
    ...
    productType: vine.enum(['digital', 'physical', 'service']),
    ...
    billingCycle: vine.enum(['one_time', 'monthly', 'yearly']).optional(),
...
export const updateProductValidator = vine.create({
    ...
    category: vine
        ...
        .optional(),
    productType: vine.enum(['digital', 'physical', 'service']).optional(),
